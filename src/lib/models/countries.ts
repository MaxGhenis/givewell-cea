...
export const MC_COUNTRY_PARAMS: Record<MCCountry, Omit<MalariaConsortiumInputs, "grantSize">> = {
  burkina_faso: {
    ...
    moralWeightUnder5: 116.25262,
    adjustmentOlderMortalities: 0.069,
    adjustmentDevelopmental: 0.261,
  ...
  chad: {
    ...
    smcEffect: 0.7936949983,
    moralWeightUnder5: 116.25262,
    adjustmentOlderMortalities: 0.073,
    adjustmentDevelopmental: 0.209,
  ...
  cote_divoire: {
    ...
    smcEffect: 0.7936949983,
    moralWeightUnder5: 116.25262,
    adjustmentOlderMortalities: 0.105,
    adjustmentDevelopmental: 0.371,
  ...
  drc_haut_katanga: {
    costPerChildReached: 7.774884,
    proportionMortalityDuringSeason: 0.52,
...
export const GD_COUNTRY_PARAMS: Record<GDCountry, Omit<GiveDirectlyInputs, "grantSize">> = {
  kenya: {
    transferAmount: 1000,
    overheadRate: 0.20,
    baselineConsumption: 322.7202158,
  ...
  malawi: {
    transferAmount: 1000,
    overheadRate: 0.20,
    baselineConsumption: 88.37333333,
    consumptionPersistenceYears: 10,
    discountRate: 0.04,
    spilloverMultiplier: 2.5,
    spilloverDiscount: 0.45,
  ...
  uganda: {
    transferAmount: 1000,
    overheadRate: 0.20,
    baselineConsumption: 220.1379066,
    consumptionPersistenceYears: 10,
    discountRate: 0.04,
    spilloverMultiplier: 2.5,
    spilloverDiscount: 0.45,
